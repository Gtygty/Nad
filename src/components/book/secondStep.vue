<template>
    <div class="secondStep">
        ...
        <easytable
             ...
             style="overflow: auto;margin: 0 auto;height: 600px;"
        ></easytable>
    </div>
</template>
<script>
...
export default {
    ...
    data () {
        return {
            tableData: [
                {"name":"赵伟","gender":"男","birthday":'1963-7-9',"height":"183","email":"zhao@gmail.com","tel":"156*****1987","hobby":"钢琴、书法、唱歌","address":"上海市黄浦区金陵东路569号17楼"},
            ...
            columns:[
                {field: 'name', title:'姓名', width: 150, titleAlign: 'center',columnAlign:'center', isFrozen: false},
                {field: 'gender', title:'性别', width: 150, titleAlign: 'center',columnAlign:'center', isFrozen: false},
        ...
        cellMerge(rowIndex,rowData,field){
            if (field === 'name' && rowData[field] === '李伟') {
                return {
                    colSpan: 2,
                    rowSpan: 1,
                    content: '<Button type="success" style="color:red" @click="aaa(111)">单元格 colSpan</Button>',
                    componentName: ''
...
Vue.component('table-cell-merge',{
    template:`<Button type="primary" style="color:red">
